...
def get_or_create_spark_session():
    ...
    Includes Hive metastore support for Oracle Health HealtheDataLab environment.
    Set HADOOP_CONF_DIR=/etc/jupyter/configs before importing for metastore access.

    Returns:
        SparkSession: The active Spark session
    """
    # Ensure HADOOP_CONF_DIR is set for metastore access (Oracle Health HealtheDataLab)
